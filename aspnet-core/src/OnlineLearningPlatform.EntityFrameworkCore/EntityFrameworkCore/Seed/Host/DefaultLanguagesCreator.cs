...
namespace OnlineLearningPlatform.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = OnlineLearningPlatformConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(OnlineLearningPlatformDbContext context)
        {
            _context = context;
        }
