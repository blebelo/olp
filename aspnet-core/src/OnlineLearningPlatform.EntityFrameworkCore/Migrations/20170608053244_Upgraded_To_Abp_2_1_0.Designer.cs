...
namespace OnlineLearningPlatform.Migrations
{
    ...
    partial class Upgraded_To_Abp_2_1_0
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("OnlineLearningPlatform.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("OnlineLearningPlatform.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("OnlineLearningPlatform.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("OnlineLearningPlatform.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("OnlineLearningPlatform.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("OnlineLearningPlatform.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
