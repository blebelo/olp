...
{
    public abstract class OnlineLearningPlatformWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OnlineLearningPlatformWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OnlineLearningPlatformWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OnlineLearningPlatformDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OnlineLearningPlatformDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OnlineLearningPlatformDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OnlineLearningPlatformDbContext, Task<T>> func)
        {
            T result;
